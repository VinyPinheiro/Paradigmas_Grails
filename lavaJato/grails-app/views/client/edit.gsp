...
<html>
    <head>
        ...
        <title><g:message code="default.edit.label" args="["Cliente"]" /></title>
    </head>
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="list" action="index"><g:message code="default.list.label" args="["Cliente"]" /></g:link></li>
                <li><g:link class="create" action="create"><g:message code="default.new.label" args="["Cliente"]" /></g:link></li>
            </ul>
        </div>
        <div id="edit-client" class="content scaffold-edit" role="main">
            <h1><g:message code="default.edit.label" args="["Cliente"]" /></h1>
